...
// checks if the HandlerStampDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HandlerStampDetail{}

// HandlerStampDetail struct for HandlerStampDetail
type HandlerStampDetail struct {
...
func (o HandlerStampDetail) MarshalJSON() ([]byte, error) {
...
func (o HandlerStampDetail) ToMap() (map[string]interface{}, error) {
...
type NullableHandlerStampDetail struct {
	value *HandlerStampDetail
	isSet bool
}

func (v NullableHandlerStampDetail) Get() *HandlerStampDetail {
	return v.value
}

func (v *NullableHandlerStampDetail) Set(val *HandlerStampDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableHandlerStampDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableHandlerStampDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHandlerStampDetail(val *HandlerStampDetail) *NullableHandlerStampDetail {
	return &NullableHandlerStampDetail{value: val, isSet: true}
}

func (v NullableHandlerStampDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHandlerStampDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
