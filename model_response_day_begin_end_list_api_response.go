...
// checks if the ResponseDayBeginEndListAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseDayBeginEndListAPIResponse{}

// ResponseDayBeginEndListAPIResponse struct for ResponseDayBeginEndListAPIResponse
type ResponseDayBeginEndListAPIResponse struct {
...
func NewResponseDayBeginEndListAPIResponse() *ResponseDayBeginEndListAPIResponse {
	this := ResponseDayBeginEndListAPIResponse{}
	return &this
}
...
func (o ResponseDayBeginEndListAPIResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseDayBeginEndListAPIResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseDayBeginEndListAPIResponse struct {
	value *ResponseDayBeginEndListAPIResponse
	isSet bool
}

func (v NullableResponseDayBeginEndListAPIResponse) Get() *ResponseDayBeginEndListAPIResponse {
	return v.value
}

func (v *NullableResponseDayBeginEndListAPIResponse) Set(val *ResponseDayBeginEndListAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseDayBeginEndListAPIResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseDayBeginEndListAPIResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseDayBeginEndListAPIResponse(val *ResponseDayBeginEndListAPIResponse) *NullableResponseDayBeginEndListAPIResponse {
	return &NullableResponseDayBeginEndListAPIResponse{value: val, isSet: true}
}

func (v NullableResponseDayBeginEndListAPIResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseDayBeginEndListAPIResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
