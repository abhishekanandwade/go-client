...
// checks if the ResponseListAccountCodesApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListAccountCodesApiResponse{}

// ResponseListAccountCodesApiResponse struct for ResponseListAccountCodesApiResponse
type ResponseListAccountCodesApiResponse struct {
	Data []ResponseAccountsMaster `json:"data,omitempty"`
...
func NewResponseListAccountCodesApiResponse() *ResponseListAccountCodesApiResponse {
	this := ResponseListAccountCodesApiResponse{}
	return &this
}
...
func (o *ResponseListAccountCodesApiResponse) GetData() []ResponseAccountsMaster {
	if o == nil || IsNil(o.Data) {
		var ret []ResponseAccountsMaster
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ResponseAccountsMaster and assigns it to the Data field.
...
func (o ResponseListAccountCodesApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListAccountCodesApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListAccountCodesApiResponse struct {
	value *ResponseListAccountCodesApiResponse
	isSet bool
}

func (v NullableResponseListAccountCodesApiResponse) Get() *ResponseListAccountCodesApiResponse {
	return v.value
}

func (v *NullableResponseListAccountCodesApiResponse) Set(val *ResponseListAccountCodesApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListAccountCodesApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListAccountCodesApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListAccountCodesApiResponse(val *ResponseListAccountCodesApiResponse) *NullableResponseListAccountCodesApiResponse {
	return &NullableResponseListAccountCodesApiResponse{value: val, isSet: true}
}

func (v NullableResponseListAccountCodesApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListAccountCodesApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
