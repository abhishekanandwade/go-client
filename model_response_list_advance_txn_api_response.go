...
// checks if the ResponseListAdvanceTxnApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListAdvanceTxnApiResponse{}

// ResponseListAdvanceTxnApiResponse struct for ResponseListAdvanceTxnApiResponse
type ResponseListAdvanceTxnApiResponse struct {
...
func NewResponseListAdvanceTxnApiResponse() *ResponseListAdvanceTxnApiResponse {
	this := ResponseListAdvanceTxnApiResponse{}
	return &this
}
...
func (o ResponseListAdvanceTxnApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListAdvanceTxnApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListAdvanceTxnApiResponse struct {
	value *ResponseListAdvanceTxnApiResponse
	isSet bool
}

func (v NullableResponseListAdvanceTxnApiResponse) Get() *ResponseListAdvanceTxnApiResponse {
	return v.value
}

func (v *NullableResponseListAdvanceTxnApiResponse) Set(val *ResponseListAdvanceTxnApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListAdvanceTxnApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListAdvanceTxnApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListAdvanceTxnApiResponse(val *ResponseListAdvanceTxnApiResponse) *NullableResponseListAdvanceTxnApiResponse {
	return &NullableResponseListAdvanceTxnApiResponse{value: val, isSet: true}
}

func (v NullableResponseListAdvanceTxnApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListAdvanceTxnApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
