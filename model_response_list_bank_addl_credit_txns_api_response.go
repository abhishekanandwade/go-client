...
// checks if the ResponseListBankAddlCreditTxnsApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListBankAddlCreditTxnsApiResponse{}

// ResponseListBankAddlCreditTxnsApiResponse struct for ResponseListBankAddlCreditTxnsApiResponse
type ResponseListBankAddlCreditTxnsApiResponse struct {
...
func NewResponseListBankAddlCreditTxnsApiResponse() *ResponseListBankAddlCreditTxnsApiResponse {
	this := ResponseListBankAddlCreditTxnsApiResponse{}
	return &this
}
...
func (o ResponseListBankAddlCreditTxnsApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListBankAddlCreditTxnsApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListBankAddlCreditTxnsApiResponse struct {
	value *ResponseListBankAddlCreditTxnsApiResponse
	isSet bool
}

func (v NullableResponseListBankAddlCreditTxnsApiResponse) Get() *ResponseListBankAddlCreditTxnsApiResponse {
	return v.value
}

func (v *NullableResponseListBankAddlCreditTxnsApiResponse) Set(val *ResponseListBankAddlCreditTxnsApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListBankAddlCreditTxnsApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListBankAddlCreditTxnsApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListBankAddlCreditTxnsApiResponse(val *ResponseListBankAddlCreditTxnsApiResponse) *NullableResponseListBankAddlCreditTxnsApiResponse {
	return &NullableResponseListBankAddlCreditTxnsApiResponse{value: val, isSet: true}
}

func (v NullableResponseListBankAddlCreditTxnsApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListBankAddlCreditTxnsApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
