...
// checks if the ResponseListBankRemittancesApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListBankRemittancesApiResponse{}

// ResponseListBankRemittancesApiResponse struct for ResponseListBankRemittancesApiResponse
type ResponseListBankRemittancesApiResponse struct {
	Data []ResponseBankRemittances `json:"data,omitempty"`
...
func NewResponseListBankRemittancesApiResponse() *ResponseListBankRemittancesApiResponse {
	this := ResponseListBankRemittancesApiResponse{}
	return &this
}
...
func (o *ResponseListBankRemittancesApiResponse) GetData() []ResponseBankRemittances {
	if o == nil || IsNil(o.Data) {
		var ret []ResponseBankRemittances
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ResponseBankRemittances and assigns it to the Data field.
...
func (o ResponseListBankRemittancesApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListBankRemittancesApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListBankRemittancesApiResponse struct {
	value *ResponseListBankRemittancesApiResponse
	isSet bool
}

func (v NullableResponseListBankRemittancesApiResponse) Get() *ResponseListBankRemittancesApiResponse {
	return v.value
}

func (v *NullableResponseListBankRemittancesApiResponse) Set(val *ResponseListBankRemittancesApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListBankRemittancesApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListBankRemittancesApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListBankRemittancesApiResponse(val *ResponseListBankRemittancesApiResponse) *NullableResponseListBankRemittancesApiResponse {
	return &NullableResponseListBankRemittancesApiResponse{value: val, isSet: true}
}

func (v NullableResponseListBankRemittancesApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListBankRemittancesApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
