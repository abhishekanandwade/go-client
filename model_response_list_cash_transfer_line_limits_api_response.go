...
// checks if the ResponseListCashTransferLineLimitsAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListCashTransferLineLimitsAPIResponse{}

// ResponseListCashTransferLineLimitsAPIResponse struct for ResponseListCashTransferLineLimitsAPIResponse
type ResponseListCashTransferLineLimitsAPIResponse struct {
...
func NewResponseListCashTransferLineLimitsAPIResponse() *ResponseListCashTransferLineLimitsAPIResponse {
	this := ResponseListCashTransferLineLimitsAPIResponse{}
	return &this
}
...
func (o ResponseListCashTransferLineLimitsAPIResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListCashTransferLineLimitsAPIResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListCashTransferLineLimitsAPIResponse struct {
	value *ResponseListCashTransferLineLimitsAPIResponse
	isSet bool
}

func (v NullableResponseListCashTransferLineLimitsAPIResponse) Get() *ResponseListCashTransferLineLimitsAPIResponse {
	return v.value
}

func (v *NullableResponseListCashTransferLineLimitsAPIResponse) Set(val *ResponseListCashTransferLineLimitsAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListCashTransferLineLimitsAPIResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListCashTransferLineLimitsAPIResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListCashTransferLineLimitsAPIResponse(val *ResponseListCashTransferLineLimitsAPIResponse) *NullableResponseListCashTransferLineLimitsAPIResponse {
	return &NullableResponseListCashTransferLineLimitsAPIResponse{value: val, isSet: true}
}

func (v NullableResponseListCashTransferLineLimitsAPIResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListCashTransferLineLimitsAPIResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
