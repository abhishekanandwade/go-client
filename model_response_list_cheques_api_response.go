...
// checks if the ResponseListChequesApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListChequesApiResponse{}

// ResponseListChequesApiResponse struct for ResponseListChequesApiResponse
type ResponseListChequesApiResponse struct {
...
func NewResponseListChequesApiResponse() *ResponseListChequesApiResponse {
	this := ResponseListChequesApiResponse{}
	return &this
}
...
func (o ResponseListChequesApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListChequesApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListChequesApiResponse struct {
	value *ResponseListChequesApiResponse
	isSet bool
}

func (v NullableResponseListChequesApiResponse) Get() *ResponseListChequesApiResponse {
	return v.value
}

func (v *NullableResponseListChequesApiResponse) Set(val *ResponseListChequesApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListChequesApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListChequesApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListChequesApiResponse(val *ResponseListChequesApiResponse) *NullableResponseListChequesApiResponse {
	return &NullableResponseListChequesApiResponse{value: val, isSet: true}
}

func (v NullableResponseListChequesApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListChequesApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
