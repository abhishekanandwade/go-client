...
// checks if the ResponseListCurrenciesAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListCurrenciesAPIResponse{}

// ResponseListCurrenciesAPIResponse struct for ResponseListCurrenciesAPIResponse
type ResponseListCurrenciesAPIResponse struct {
	Data []ResponseCurrenciesResponse `json:"data,omitempty"`
...
func NewResponseListCurrenciesAPIResponse() *ResponseListCurrenciesAPIResponse {
	this := ResponseListCurrenciesAPIResponse{}
	return &this
}
...
func (o *ResponseListCurrenciesAPIResponse) GetData() []ResponseCurrenciesResponse {
	if o == nil || IsNil(o.Data) {
		var ret []ResponseCurrenciesResponse
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ResponseCurrenciesResponse and assigns it to the Data field.
...
func (o ResponseListCurrenciesAPIResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListCurrenciesAPIResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListCurrenciesAPIResponse struct {
	value *ResponseListCurrenciesAPIResponse
	isSet bool
}

func (v NullableResponseListCurrenciesAPIResponse) Get() *ResponseListCurrenciesAPIResponse {
	return v.value
}

func (v *NullableResponseListCurrenciesAPIResponse) Set(val *ResponseListCurrenciesAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListCurrenciesAPIResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListCurrenciesAPIResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListCurrenciesAPIResponse(val *ResponseListCurrenciesAPIResponse) *NullableResponseListCurrenciesAPIResponse {
	return &NullableResponseListCurrenciesAPIResponse{value: val, isSet: true}
}

func (v NullableResponseListCurrenciesAPIResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListCurrenciesAPIResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
