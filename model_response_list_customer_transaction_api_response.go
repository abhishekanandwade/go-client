...
// checks if the ResponseListCustomerTransactionAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListCustomerTransactionAPIResponse{}

// ResponseListCustomerTransactionAPIResponse struct for ResponseListCustomerTransactionAPIResponse
type ResponseListCustomerTransactionAPIResponse struct {
	Data []ResponseCustomerTransaction `json:"data,omitempty"`
...
func NewResponseListCustomerTransactionAPIResponse() *ResponseListCustomerTransactionAPIResponse {
	this := ResponseListCustomerTransactionAPIResponse{}
	return &this
}
...
func (o *ResponseListCustomerTransactionAPIResponse) GetData() []ResponseCustomerTransaction {
	if o == nil || IsNil(o.Data) {
		var ret []ResponseCustomerTransaction
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ResponseCustomerTransaction and assigns it to the Data field.
...
func (o ResponseListCustomerTransactionAPIResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListCustomerTransactionAPIResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListCustomerTransactionAPIResponse struct {
	value *ResponseListCustomerTransactionAPIResponse
	isSet bool
}

func (v NullableResponseListCustomerTransactionAPIResponse) Get() *ResponseListCustomerTransactionAPIResponse {
	return v.value
}

func (v *NullableResponseListCustomerTransactionAPIResponse) Set(val *ResponseListCustomerTransactionAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListCustomerTransactionAPIResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListCustomerTransactionAPIResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListCustomerTransactionAPIResponse(val *ResponseListCustomerTransactionAPIResponse) *NullableResponseListCustomerTransactionAPIResponse {
	return &NullableResponseListCustomerTransactionAPIResponse{value: val, isSet: true}
}

func (v NullableResponseListCustomerTransactionAPIResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListCustomerTransactionAPIResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
