...
// checks if the ResponseListIPOErrorTransactionsAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListIPOErrorTransactionsAPIResponse{}

// ResponseListIPOErrorTransactionsAPIResponse struct for ResponseListIPOErrorTransactionsAPIResponse
type ResponseListIPOErrorTransactionsAPIResponse struct {
...
func NewResponseListIPOErrorTransactionsAPIResponse() *ResponseListIPOErrorTransactionsAPIResponse {
	this := ResponseListIPOErrorTransactionsAPIResponse{}
	return &this
}
...
func (o ResponseListIPOErrorTransactionsAPIResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListIPOErrorTransactionsAPIResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListIPOErrorTransactionsAPIResponse struct {
	value *ResponseListIPOErrorTransactionsAPIResponse
	isSet bool
}

func (v NullableResponseListIPOErrorTransactionsAPIResponse) Get() *ResponseListIPOErrorTransactionsAPIResponse {
	return v.value
}

func (v *NullableResponseListIPOErrorTransactionsAPIResponse) Set(val *ResponseListIPOErrorTransactionsAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListIPOErrorTransactionsAPIResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListIPOErrorTransactionsAPIResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListIPOErrorTransactionsAPIResponse(val *ResponseListIPOErrorTransactionsAPIResponse) *NullableResponseListIPOErrorTransactionsAPIResponse {
	return &NullableResponseListIPOErrorTransactionsAPIResponse{value: val, isSet: true}
}

func (v NullableResponseListIPOErrorTransactionsAPIResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListIPOErrorTransactionsAPIResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
