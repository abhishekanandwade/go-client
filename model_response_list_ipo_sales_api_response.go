...
// checks if the ResponseListIPOSalesApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListIPOSalesApiResponse{}

// ResponseListIPOSalesApiResponse struct for ResponseListIPOSalesApiResponse
type ResponseListIPOSalesApiResponse struct {
...
func NewResponseListIPOSalesApiResponse() *ResponseListIPOSalesApiResponse {
	this := ResponseListIPOSalesApiResponse{}
	return &this
}
...
func (o ResponseListIPOSalesApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListIPOSalesApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListIPOSalesApiResponse struct {
	value *ResponseListIPOSalesApiResponse
	isSet bool
}

func (v NullableResponseListIPOSalesApiResponse) Get() *ResponseListIPOSalesApiResponse {
	return v.value
}

func (v *NullableResponseListIPOSalesApiResponse) Set(val *ResponseListIPOSalesApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListIPOSalesApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListIPOSalesApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListIPOSalesApiResponse(val *ResponseListIPOSalesApiResponse) *NullableResponseListIPOSalesApiResponse {
	return &NullableResponseListIPOSalesApiResponse{value: val, isSet: true}
}

func (v NullableResponseListIPOSalesApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListIPOSalesApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
