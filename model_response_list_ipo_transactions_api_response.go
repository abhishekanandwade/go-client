...
// checks if the ResponseListIPOTransactionsApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListIPOTransactionsApiResponse{}

// ResponseListIPOTransactionsApiResponse struct for ResponseListIPOTransactionsApiResponse
type ResponseListIPOTransactionsApiResponse struct {
...
func NewResponseListIPOTransactionsApiResponse() *ResponseListIPOTransactionsApiResponse {
	this := ResponseListIPOTransactionsApiResponse{}
	return &this
}
...
func (o ResponseListIPOTransactionsApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListIPOTransactionsApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListIPOTransactionsApiResponse struct {
	value *ResponseListIPOTransactionsApiResponse
	isSet bool
}

func (v NullableResponseListIPOTransactionsApiResponse) Get() *ResponseListIPOTransactionsApiResponse {
	return v.value
}

func (v *NullableResponseListIPOTransactionsApiResponse) Set(val *ResponseListIPOTransactionsApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListIPOTransactionsApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListIPOTransactionsApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListIPOTransactionsApiResponse(val *ResponseListIPOTransactionsApiResponse) *NullableResponseListIPOTransactionsApiResponse {
	return &NullableResponseListIPOTransactionsApiResponse{value: val, isSet: true}
}

func (v NullableResponseListIPOTransactionsApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListIPOTransactionsApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
