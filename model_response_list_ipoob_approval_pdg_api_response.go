...
// checks if the ResponseListIPOOBApprovalPdgApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListIPOOBApprovalPdgApiResponse{}

// ResponseListIPOOBApprovalPdgApiResponse struct for ResponseListIPOOBApprovalPdgApiResponse
type ResponseListIPOOBApprovalPdgApiResponse struct {
...
func NewResponseListIPOOBApprovalPdgApiResponse() *ResponseListIPOOBApprovalPdgApiResponse {
	this := ResponseListIPOOBApprovalPdgApiResponse{}
	return &this
}
...
func (o *ResponseListIPOOBApprovalPdgApiResponse) SetData(v []ResponseIposOBReceipts) {
	o.Data = v
}
...
func (o ResponseListIPOOBApprovalPdgApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListIPOOBApprovalPdgApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListIPOOBApprovalPdgApiResponse struct {
	value *ResponseListIPOOBApprovalPdgApiResponse
	isSet bool
}

func (v NullableResponseListIPOOBApprovalPdgApiResponse) Get() *ResponseListIPOOBApprovalPdgApiResponse {
	return v.value
}

func (v *NullableResponseListIPOOBApprovalPdgApiResponse) Set(val *ResponseListIPOOBApprovalPdgApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListIPOOBApprovalPdgApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListIPOOBApprovalPdgApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListIPOOBApprovalPdgApiResponse(val *ResponseListIPOOBApprovalPdgApiResponse) *NullableResponseListIPOOBApprovalPdgApiResponse {
	return &NullableResponseListIPOOBApprovalPdgApiResponse{value: val, isSet: true}
}

func (v NullableResponseListIPOOBApprovalPdgApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListIPOOBApprovalPdgApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
