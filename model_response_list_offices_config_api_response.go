...
// checks if the ResponseListOfficesConfigAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListOfficesConfigAPIResponse{}

// ResponseListOfficesConfigAPIResponse struct for ResponseListOfficesConfigAPIResponse
type ResponseListOfficesConfigAPIResponse struct {
	Data []ResponseKafkaOfficeDetails `json:"data,omitempty"`
...
func NewResponseListOfficesConfigAPIResponse() *ResponseListOfficesConfigAPIResponse {
	this := ResponseListOfficesConfigAPIResponse{}
	return &this
}
...
func (o *ResponseListOfficesConfigAPIResponse) GetData() []ResponseKafkaOfficeDetails {
	if o == nil || IsNil(o.Data) {
		var ret []ResponseKafkaOfficeDetails
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ResponseKafkaOfficeDetails and assigns it to the Data field.
...
func (o ResponseListOfficesConfigAPIResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListOfficesConfigAPIResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListOfficesConfigAPIResponse struct {
	value *ResponseListOfficesConfigAPIResponse
	isSet bool
}

func (v NullableResponseListOfficesConfigAPIResponse) Get() *ResponseListOfficesConfigAPIResponse {
	return v.value
}

func (v *NullableResponseListOfficesConfigAPIResponse) Set(val *ResponseListOfficesConfigAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListOfficesConfigAPIResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListOfficesConfigAPIResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListOfficesConfigAPIResponse(val *ResponseListOfficesConfigAPIResponse) *NullableResponseListOfficesConfigAPIResponse {
	return &NullableResponseListOfficesConfigAPIResponse{value: val, isSet: true}
}

func (v NullableResponseListOfficesConfigAPIResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListOfficesConfigAPIResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
