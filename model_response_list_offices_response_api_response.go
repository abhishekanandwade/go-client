...
// checks if the ResponseListOfficesResponseAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListOfficesResponseAPIResponse{}

// ResponseListOfficesResponseAPIResponse struct for ResponseListOfficesResponseAPIResponse
type ResponseListOfficesResponseAPIResponse struct {
...
func NewResponseListOfficesResponseAPIResponse() *ResponseListOfficesResponseAPIResponse {
	this := ResponseListOfficesResponseAPIResponse{}
	return &this
}
...
func (o ResponseListOfficesResponseAPIResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListOfficesResponseAPIResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListOfficesResponseAPIResponse struct {
	value *ResponseListOfficesResponseAPIResponse
	isSet bool
}

func (v NullableResponseListOfficesResponseAPIResponse) Get() *ResponseListOfficesResponseAPIResponse {
	return v.value
}

func (v *NullableResponseListOfficesResponseAPIResponse) Set(val *ResponseListOfficesResponseAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListOfficesResponseAPIResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListOfficesResponseAPIResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListOfficesResponseAPIResponse(val *ResponseListOfficesResponseAPIResponse) *NullableResponseListOfficesResponseAPIResponse {
	return &NullableResponseListOfficesResponseAPIResponse{value: val, isSet: true}
}

func (v NullableResponseListOfficesResponseAPIResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListOfficesResponseAPIResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
