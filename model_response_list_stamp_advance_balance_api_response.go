...
// checks if the ResponseListStampAdvanceBalanceApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListStampAdvanceBalanceApiResponse{}

// ResponseListStampAdvanceBalanceApiResponse struct for ResponseListStampAdvanceBalanceApiResponse
type ResponseListStampAdvanceBalanceApiResponse struct {
	Data []ResponseListStampAdvanceBalance `json:"data,omitempty"`
...
func NewResponseListStampAdvanceBalanceApiResponse() *ResponseListStampAdvanceBalanceApiResponse {
	this := ResponseListStampAdvanceBalanceApiResponse{}
	return &this
}
...
func (o *ResponseListStampAdvanceBalanceApiResponse) GetData() []ResponseListStampAdvanceBalance {
	if o == nil || IsNil(o.Data) {
		var ret []ResponseListStampAdvanceBalance
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ResponseListStampAdvanceBalance and assigns it to the Data field.
...
func (o ResponseListStampAdvanceBalanceApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListStampAdvanceBalanceApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListStampAdvanceBalanceApiResponse struct {
	value *ResponseListStampAdvanceBalanceApiResponse
	isSet bool
}

func (v NullableResponseListStampAdvanceBalanceApiResponse) Get() *ResponseListStampAdvanceBalanceApiResponse {
	return v.value
}

func (v *NullableResponseListStampAdvanceBalanceApiResponse) Set(val *ResponseListStampAdvanceBalanceApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListStampAdvanceBalanceApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListStampAdvanceBalanceApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListStampAdvanceBalanceApiResponse(val *ResponseListStampAdvanceBalanceApiResponse) *NullableResponseListStampAdvanceBalanceApiResponse {
	return &NullableResponseListStampAdvanceBalanceApiResponse{value: val, isSet: true}
}

func (v NullableResponseListStampAdvanceBalanceApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListStampAdvanceBalanceApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
