...
// checks if the ResponseListStampBulkSalesApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListStampBulkSalesApiResponse{}

// ResponseListStampBulkSalesApiResponse struct for ResponseListStampBulkSalesApiResponse
type ResponseListStampBulkSalesApiResponse struct {
	Data []ResponseStampBulkSaleResponse `json:"data,omitempty"`
...
func NewResponseListStampBulkSalesApiResponse() *ResponseListStampBulkSalesApiResponse {
	this := ResponseListStampBulkSalesApiResponse{}
	return &this
}
...
func (o *ResponseListStampBulkSalesApiResponse) GetData() []ResponseStampBulkSaleResponse {
	if o == nil || IsNil(o.Data) {
		var ret []ResponseStampBulkSaleResponse
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ResponseStampBulkSaleResponse and assigns it to the Data field.
...
func (o ResponseListStampBulkSalesApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListStampBulkSalesApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListStampBulkSalesApiResponse struct {
	value *ResponseListStampBulkSalesApiResponse
	isSet bool
}

func (v NullableResponseListStampBulkSalesApiResponse) Get() *ResponseListStampBulkSalesApiResponse {
	return v.value
}

func (v *NullableResponseListStampBulkSalesApiResponse) Set(val *ResponseListStampBulkSalesApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListStampBulkSalesApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListStampBulkSalesApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListStampBulkSalesApiResponse(val *ResponseListStampBulkSalesApiResponse) *NullableResponseListStampBulkSalesApiResponse {
	return &NullableResponseListStampBulkSalesApiResponse{value: val, isSet: true}
}

func (v NullableResponseListStampBulkSalesApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListStampBulkSalesApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
