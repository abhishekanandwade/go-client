...
// checks if the ResponseListStampObCsdReceiptsApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListStampObCsdReceiptsApiResponse{}

// ResponseListStampObCsdReceiptsApiResponse struct for ResponseListStampObCsdReceiptsApiResponse
type ResponseListStampObCsdReceiptsApiResponse struct {
...
func NewResponseListStampObCsdReceiptsApiResponse() *ResponseListStampObCsdReceiptsApiResponse {
	this := ResponseListStampObCsdReceiptsApiResponse{}
	return &this
}
...
func (o ResponseListStampObCsdReceiptsApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListStampObCsdReceiptsApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListStampObCsdReceiptsApiResponse struct {
	value *ResponseListStampObCsdReceiptsApiResponse
	isSet bool
}

func (v NullableResponseListStampObCsdReceiptsApiResponse) Get() *ResponseListStampObCsdReceiptsApiResponse {
	return v.value
}

func (v *NullableResponseListStampObCsdReceiptsApiResponse) Set(val *ResponseListStampObCsdReceiptsApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListStampObCsdReceiptsApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListStampObCsdReceiptsApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListStampObCsdReceiptsApiResponse(val *ResponseListStampObCsdReceiptsApiResponse) *NullableResponseListStampObCsdReceiptsApiResponse {
	return &NullableResponseListStampObCsdReceiptsApiResponse{value: val, isSet: true}
}

func (v NullableResponseListStampObCsdReceiptsApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListStampObCsdReceiptsApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
