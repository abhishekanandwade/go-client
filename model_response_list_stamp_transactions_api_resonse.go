...
// checks if the ResponseListStampTransactionsApiResonse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListStampTransactionsApiResonse{}

// ResponseListStampTransactionsApiResonse struct for ResponseListStampTransactionsApiResonse
type ResponseListStampTransactionsApiResonse struct {
...
func NewResponseListStampTransactionsApiResonse() *ResponseListStampTransactionsApiResonse {
	this := ResponseListStampTransactionsApiResonse{}
	return &this
}
...
func (o ResponseListStampTransactionsApiResonse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListStampTransactionsApiResonse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListStampTransactionsApiResonse struct {
	value *ResponseListStampTransactionsApiResonse
	isSet bool
}

func (v NullableResponseListStampTransactionsApiResonse) Get() *ResponseListStampTransactionsApiResonse {
	return v.value
}

func (v *NullableResponseListStampTransactionsApiResonse) Set(val *ResponseListStampTransactionsApiResonse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListStampTransactionsApiResonse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListStampTransactionsApiResonse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListStampTransactionsApiResonse(val *ResponseListStampTransactionsApiResonse) *NullableResponseListStampTransactionsApiResonse {
	return &NullableResponseListStampTransactionsApiResonse{value: val, isSet: true}
}

func (v NullableResponseListStampTransactionsApiResonse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListStampTransactionsApiResonse) UnmarshalJSON(src []byte) error {
	v.isSet = true
