...
// checks if the ResponseListStampsCategoriesAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListStampsCategoriesAPIResponse{}

// ResponseListStampsCategoriesAPIResponse struct for ResponseListStampsCategoriesAPIResponse
type ResponseListStampsCategoriesAPIResponse struct {
...
func NewResponseListStampsCategoriesAPIResponse() *ResponseListStampsCategoriesAPIResponse {
	this := ResponseListStampsCategoriesAPIResponse{}
	return &this
}
...
func (o ResponseListStampsCategoriesAPIResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListStampsCategoriesAPIResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListStampsCategoriesAPIResponse struct {
	value *ResponseListStampsCategoriesAPIResponse
	isSet bool
}

func (v NullableResponseListStampsCategoriesAPIResponse) Get() *ResponseListStampsCategoriesAPIResponse {
	return v.value
}

func (v *NullableResponseListStampsCategoriesAPIResponse) Set(val *ResponseListStampsCategoriesAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListStampsCategoriesAPIResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListStampsCategoriesAPIResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListStampsCategoriesAPIResponse(val *ResponseListStampsCategoriesAPIResponse) *NullableResponseListStampsCategoriesAPIResponse {
	return &NullableResponseListStampsCategoriesAPIResponse{value: val, isSet: true}
}

func (v NullableResponseListStampsCategoriesAPIResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListStampsCategoriesAPIResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
