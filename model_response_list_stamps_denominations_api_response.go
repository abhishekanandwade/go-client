...
// checks if the ResponseListStampsDenominationsAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListStampsDenominationsAPIResponse{}

// ResponseListStampsDenominationsAPIResponse struct for ResponseListStampsDenominationsAPIResponse
type ResponseListStampsDenominationsAPIResponse struct {
	Data []ResponseStampsDenominationsResponse `json:"data,omitempty"`
...
func NewResponseListStampsDenominationsAPIResponse() *ResponseListStampsDenominationsAPIResponse {
	this := ResponseListStampsDenominationsAPIResponse{}
	return &this
}
...
func (o *ResponseListStampsDenominationsAPIResponse) GetData() []ResponseStampsDenominationsResponse {
	if o == nil || IsNil(o.Data) {
		var ret []ResponseStampsDenominationsResponse
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ResponseStampsDenominationsResponse and assigns it to the Data field.
...
func (o ResponseListStampsDenominationsAPIResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListStampsDenominationsAPIResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListStampsDenominationsAPIResponse struct {
	value *ResponseListStampsDenominationsAPIResponse
	isSet bool
}

func (v NullableResponseListStampsDenominationsAPIResponse) Get() *ResponseListStampsDenominationsAPIResponse {
	return v.value
}

func (v *NullableResponseListStampsDenominationsAPIResponse) Set(val *ResponseListStampsDenominationsAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListStampsDenominationsAPIResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListStampsDenominationsAPIResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListStampsDenominationsAPIResponse(val *ResponseListStampsDenominationsAPIResponse) *NullableResponseListStampsDenominationsAPIResponse {
	return &NullableResponseListStampsDenominationsAPIResponse{value: val, isSet: true}
}

func (v NullableResponseListStampsDenominationsAPIResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListStampsDenominationsAPIResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
