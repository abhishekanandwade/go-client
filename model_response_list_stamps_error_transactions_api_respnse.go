...
// checks if the ResponseListStampsErrorTransactionsApiRespnse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListStampsErrorTransactionsApiRespnse{}

// ResponseListStampsErrorTransactionsApiRespnse struct for ResponseListStampsErrorTransactionsApiRespnse
type ResponseListStampsErrorTransactionsApiRespnse struct {
	Data []ResponseStampsError `json:"data,omitempty"`
...
func NewResponseListStampsErrorTransactionsApiRespnse() *ResponseListStampsErrorTransactionsApiRespnse {
	this := ResponseListStampsErrorTransactionsApiRespnse{}
	return &this
}
...
// SetData gets a reference to the given []ResponseStampsError and assigns it to the Data field.
...
func (o *ResponseListStampsErrorTransactionsApiRespnse) HasReturnedRecordsCount() bool {
	if o != nil && !IsNil(o.ReturnedRecordsCount) {
		return true
	}
...
func (o ResponseListStampsErrorTransactionsApiRespnse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListStampsErrorTransactionsApiRespnse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListStampsErrorTransactionsApiRespnse struct {
	value *ResponseListStampsErrorTransactionsApiRespnse
	isSet bool
}

func (v NullableResponseListStampsErrorTransactionsApiRespnse) Get() *ResponseListStampsErrorTransactionsApiRespnse {
	return v.value
}

func (v *NullableResponseListStampsErrorTransactionsApiRespnse) Set(val *ResponseListStampsErrorTransactionsApiRespnse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListStampsErrorTransactionsApiRespnse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListStampsErrorTransactionsApiRespnse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListStampsErrorTransactionsApiRespnse(val *ResponseListStampsErrorTransactionsApiRespnse) *NullableResponseListStampsErrorTransactionsApiRespnse {
	return &NullableResponseListStampsErrorTransactionsApiRespnse{value: val, isSet: true}
}

func (v NullableResponseListStampsErrorTransactionsApiRespnse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListStampsErrorTransactionsApiRespnse) UnmarshalJSON(src []byte) error {
	v.isSet = true
