...
// checks if the ResponseListStampsInventoryAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListStampsInventoryAPIResponse{}

// ResponseListStampsInventoryAPIResponse struct for ResponseListStampsInventoryAPIResponse
type ResponseListStampsInventoryAPIResponse struct {
	Data []ResponseStampsObReceiptsInventory `json:"data,omitempty"`
...
func NewResponseListStampsInventoryAPIResponse() *ResponseListStampsInventoryAPIResponse {
	this := ResponseListStampsInventoryAPIResponse{}
	return &this
}
...
func (o *ResponseListStampsInventoryAPIResponse) GetData() []ResponseStampsObReceiptsInventory {
	if o == nil || IsNil(o.Data) {
		var ret []ResponseStampsObReceiptsInventory
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ResponseStampsObReceiptsInventory and assigns it to the Data field.
...
func (o ResponseListStampsInventoryAPIResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListStampsInventoryAPIResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListStampsInventoryAPIResponse struct {
	value *ResponseListStampsInventoryAPIResponse
	isSet bool
}

func (v NullableResponseListStampsInventoryAPIResponse) Get() *ResponseListStampsInventoryAPIResponse {
	return v.value
}

func (v *NullableResponseListStampsInventoryAPIResponse) Set(val *ResponseListStampsInventoryAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListStampsInventoryAPIResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListStampsInventoryAPIResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListStampsInventoryAPIResponse(val *ResponseListStampsInventoryAPIResponse) *NullableResponseListStampsInventoryAPIResponse {
	return &NullableResponseListStampsInventoryAPIResponse{value: val, isSet: true}
}

func (v NullableResponseListStampsInventoryAPIResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListStampsInventoryAPIResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
