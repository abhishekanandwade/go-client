...
// checks if the ResponseListStampsSoiledApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListStampsSoiledApiResponse{}

// ResponseListStampsSoiledApiResponse struct for ResponseListStampsSoiledApiResponse
type ResponseListStampsSoiledApiResponse struct {
...
func NewResponseListStampsSoiledApiResponse() *ResponseListStampsSoiledApiResponse {
	this := ResponseListStampsSoiledApiResponse{}
	return &this
}
...
func (o ResponseListStampsSoiledApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListStampsSoiledApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListStampsSoiledApiResponse struct {
	value *ResponseListStampsSoiledApiResponse
	isSet bool
}

func (v NullableResponseListStampsSoiledApiResponse) Get() *ResponseListStampsSoiledApiResponse {
	return v.value
}

func (v *NullableResponseListStampsSoiledApiResponse) Set(val *ResponseListStampsSoiledApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListStampsSoiledApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListStampsSoiledApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListStampsSoiledApiResponse(val *ResponseListStampsSoiledApiResponse) *NullableResponseListStampsSoiledApiResponse {
	return &NullableResponseListStampsSoiledApiResponse{value: val, isSet: true}
}

func (v NullableResponseListStampsSoiledApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListStampsSoiledApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
