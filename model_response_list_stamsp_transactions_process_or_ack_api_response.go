...
// checks if the ResponseListStamspTransactionsProcessOrAckApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListStamspTransactionsProcessOrAckApiResponse{}

// ResponseListStamspTransactionsProcessOrAckApiResponse struct for ResponseListStamspTransactionsProcessOrAckApiResponse
type ResponseListStamspTransactionsProcessOrAckApiResponse struct {
	Data []ResponseStampsTransactions `json:"data,omitempty"`
...
func NewResponseListStamspTransactionsProcessOrAckApiResponse() *ResponseListStamspTransactionsProcessOrAckApiResponse {
	this := ResponseListStamspTransactionsProcessOrAckApiResponse{}
	return &this
}
...
func (o *ResponseListStamspTransactionsProcessOrAckApiResponse) GetData() []ResponseStampsTransactions {
	if o == nil || IsNil(o.Data) {
		var ret []ResponseStampsTransactions
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ResponseStampsTransactions and assigns it to the Data field.
...
func (o ResponseListStamspTransactionsProcessOrAckApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListStamspTransactionsProcessOrAckApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListStamspTransactionsProcessOrAckApiResponse struct {
	value *ResponseListStamspTransactionsProcessOrAckApiResponse
	isSet bool
}

func (v NullableResponseListStamspTransactionsProcessOrAckApiResponse) Get() *ResponseListStamspTransactionsProcessOrAckApiResponse {
	return v.value
}

func (v *NullableResponseListStamspTransactionsProcessOrAckApiResponse) Set(val *ResponseListStamspTransactionsProcessOrAckApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListStamspTransactionsProcessOrAckApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListStamspTransactionsProcessOrAckApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListStamspTransactionsProcessOrAckApiResponse(val *ResponseListStamspTransactionsProcessOrAckApiResponse) *NullableResponseListStamspTransactionsProcessOrAckApiResponse {
	return &NullableResponseListStamspTransactionsProcessOrAckApiResponse{value: val, isSet: true}
}

func (v NullableResponseListStamspTransactionsProcessOrAckApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListStamspTransactionsProcessOrAckApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
