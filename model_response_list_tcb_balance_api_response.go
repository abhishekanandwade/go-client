...
// checks if the ResponseListTcbBalanceAPIResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListTcbBalanceAPIResponse{}

// ResponseListTcbBalanceAPIResponse struct for ResponseListTcbBalanceAPIResponse
type ResponseListTcbBalanceAPIResponse struct {
...
func NewResponseListTcbBalanceAPIResponse() *ResponseListTcbBalanceAPIResponse {
	this := ResponseListTcbBalanceAPIResponse{}
	return &this
}
...
func (o ResponseListTcbBalanceAPIResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListTcbBalanceAPIResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListTcbBalanceAPIResponse struct {
	value *ResponseListTcbBalanceAPIResponse
	isSet bool
}

func (v NullableResponseListTcbBalanceAPIResponse) Get() *ResponseListTcbBalanceAPIResponse {
	return v.value
}

func (v *NullableResponseListTcbBalanceAPIResponse) Set(val *ResponseListTcbBalanceAPIResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListTcbBalanceAPIResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListTcbBalanceAPIResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListTcbBalanceAPIResponse(val *ResponseListTcbBalanceAPIResponse) *NullableResponseListTcbBalanceAPIResponse {
	return &NullableResponseListTcbBalanceAPIResponse{value: val, isSet: true}
}

func (v NullableResponseListTcbBalanceAPIResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListTcbBalanceAPIResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
