...
// checks if the ResponseListTransactionPendingApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListTransactionPendingApiResponse{}

// ResponseListTransactionPendingApiResponse struct for ResponseListTransactionPendingApiResponse
type ResponseListTransactionPendingApiResponse struct {
	Data []ResponseTransactionStatus `json:"data,omitempty"`
...
func NewResponseListTransactionPendingApiResponse() *ResponseListTransactionPendingApiResponse {
	this := ResponseListTransactionPendingApiResponse{}
	return &this
}
...
func (o *ResponseListTransactionPendingApiResponse) GetData() []ResponseTransactionStatus {
	if o == nil || IsNil(o.Data) {
		var ret []ResponseTransactionStatus
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ResponseTransactionStatus and assigns it to the Data field.
...
func (o ResponseListTransactionPendingApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListTransactionPendingApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListTransactionPendingApiResponse struct {
	value *ResponseListTransactionPendingApiResponse
	isSet bool
}

func (v NullableResponseListTransactionPendingApiResponse) Get() *ResponseListTransactionPendingApiResponse {
	return v.value
}

func (v *NullableResponseListTransactionPendingApiResponse) Set(val *ResponseListTransactionPendingApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListTransactionPendingApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListTransactionPendingApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListTransactionPendingApiResponse(val *ResponseListTransactionPendingApiResponse) *NullableResponseListTransactionPendingApiResponse {
	return &NullableResponseListTransactionPendingApiResponse{value: val, isSet: true}
}

func (v NullableResponseListTransactionPendingApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListTransactionPendingApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
