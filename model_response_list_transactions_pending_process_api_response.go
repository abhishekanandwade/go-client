...
// checks if the ResponseListTransactionsPendingProcessApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListTransactionsPendingProcessApiResponse{}

// ResponseListTransactionsPendingProcessApiResponse struct for ResponseListTransactionsPendingProcessApiResponse
type ResponseListTransactionsPendingProcessApiResponse struct {
...
func NewResponseListTransactionsPendingProcessApiResponse() *ResponseListTransactionsPendingProcessApiResponse {
	this := ResponseListTransactionsPendingProcessApiResponse{}
	return &this
}
...
func (o ResponseListTransactionsPendingProcessApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListTransactionsPendingProcessApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListTransactionsPendingProcessApiResponse struct {
	value *ResponseListTransactionsPendingProcessApiResponse
	isSet bool
}

func (v NullableResponseListTransactionsPendingProcessApiResponse) Get() *ResponseListTransactionsPendingProcessApiResponse {
	return v.value
}

func (v *NullableResponseListTransactionsPendingProcessApiResponse) Set(val *ResponseListTransactionsPendingProcessApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListTransactionsPendingProcessApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListTransactionsPendingProcessApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListTransactionsPendingProcessApiResponse(val *ResponseListTransactionsPendingProcessApiResponse) *NullableResponseListTransactionsPendingProcessApiResponse {
	return &NullableResponseListTransactionsPendingProcessApiResponse{value: val, isSet: true}
}

func (v NullableResponseListTransactionsPendingProcessApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListTransactionsPendingProcessApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
