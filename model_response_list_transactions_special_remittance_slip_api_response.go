...
// checks if the ResponseListTransactionsSpecialRemittanceSlipApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListTransactionsSpecialRemittanceSlipApiResponse{}

// ResponseListTransactionsSpecialRemittanceSlipApiResponse struct for ResponseListTransactionsSpecialRemittanceSlipApiResponse
type ResponseListTransactionsSpecialRemittanceSlipApiResponse struct {
	Data []ResponseSpecialRemittanceSlip `json:"data,omitempty"`
...
func NewResponseListTransactionsSpecialRemittanceSlipApiResponse() *ResponseListTransactionsSpecialRemittanceSlipApiResponse {
	this := ResponseListTransactionsSpecialRemittanceSlipApiResponse{}
	return &this
}
...
func (o *ResponseListTransactionsSpecialRemittanceSlipApiResponse) GetData() []ResponseSpecialRemittanceSlip {
	if o == nil || IsNil(o.Data) {
		var ret []ResponseSpecialRemittanceSlip
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ResponseSpecialRemittanceSlip and assigns it to the Data field.
...
func (o ResponseListTransactionsSpecialRemittanceSlipApiResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseListTransactionsSpecialRemittanceSlipApiResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponseListTransactionsSpecialRemittanceSlipApiResponse struct {
	value *ResponseListTransactionsSpecialRemittanceSlipApiResponse
	isSet bool
}

func (v NullableResponseListTransactionsSpecialRemittanceSlipApiResponse) Get() *ResponseListTransactionsSpecialRemittanceSlipApiResponse {
	return v.value
}

func (v *NullableResponseListTransactionsSpecialRemittanceSlipApiResponse) Set(val *ResponseListTransactionsSpecialRemittanceSlipApiResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListTransactionsSpecialRemittanceSlipApiResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListTransactionsSpecialRemittanceSlipApiResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListTransactionsSpecialRemittanceSlipApiResponse(val *ResponseListTransactionsSpecialRemittanceSlipApiResponse) *NullableResponseListTransactionsSpecialRemittanceSlipApiResponse {
	return &NullableResponseListTransactionsSpecialRemittanceSlipApiResponse{value: val, isSet: true}
}

func (v NullableResponseListTransactionsSpecialRemittanceSlipApiResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListTransactionsSpecialRemittanceSlipApiResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
